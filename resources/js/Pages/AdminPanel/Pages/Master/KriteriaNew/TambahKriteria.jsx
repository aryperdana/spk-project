...
const TambahKriteria = () => {
    ...
    return (
        <MainLayout title="Kriteria" navbarTitle="Tambah Kriteria">
            <form onSubmit={submit}>
                <div className="flex justify-between mb-3">
                    <div className="font-bold">Tambah Kriteria</div>
                ...
                <div className="font-bold mt-4">Tambah Sub Kriteria</div>
                <div className="card w-full bg-base-100 shadow-sm ">
                    <div className="card-body">
